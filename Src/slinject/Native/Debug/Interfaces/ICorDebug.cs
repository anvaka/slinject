...
namespace slinject.Native.Debug.Interfaces
{
    ...
    public interface ICorDebug
    {
        ...
        //
        Int32 CanLaunchOrAttach([In] uint dwProcessId, [In] int win32DebuggingEnabled);
    }
    ...
    public class CorDebugClass : ICorDebug, CorDebug
    {
        ...
        public virtual extern int CanLaunchOrAttach([In] uint dwProcessId, [In] int win32DebuggingEnabled);
